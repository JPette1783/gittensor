...
from gittensor.validator.utils.datetime_utils import get_lookback_cutoff, parse_github_iso_to_utc
...
def load_miners_prs(
    ...
    lookback_date_filter = get_lookback_cutoff(PR_LOOKBACK_DAYS)
